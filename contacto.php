...
<body>
    ...
    <main class="contenedor blanco">
        ...
        <div class="contacto"></div>
            <form class="formulario sombra" action="enviar.php" method="post" id="contacto">
                <div class="campo">
                    <label class="campo__label" for="">Nombre</label>
                    <input class="campo__field" type="text" name="nombre" id="nombre" placeholder="Nombre">
                </div>
                <div class="campo">
                    <label class="campo__label" for="">Email</label>
                    <input class="campo__field" type="email" name="email" id="email" placeholder="Email">
                </div>
                <div class="campo">
