...
<header class="header" id="header">
        ...
        <div class="contenedor">
            <div class="barra">
                ...
                <nav class="navegacion">
                    <a class="btn btn--cerrar" href="../index.php">Volver</a>
                </nav>
            </div>
        </div>
    </header>
    ...
    <main class="contenedor blanco">
        <h1 class="contacto-titulo">Inicia sesión</h1>
        <p class="contacto__dudas">Regístrate o inicia sesión </p>
        <div class="contacto"></div>
            <form class="formulario sombra" action="autentificar.php" method="post">
                <div class="campo">
                    <input class="login__field" type="text" name="usuario" placeholder="Usuario">
                </div>
                <div class="campo">
                    <input class="login__field" type="password" name="contrasena" placeholder="Contraseña">
                </div>
                <div class="campo">
